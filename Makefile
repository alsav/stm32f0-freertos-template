...
CFLAGS+=-I./stm32_lib/cmsis -I./stm32_lib -I./stm32_lib/inc -I. -I./freertos/ -I./freertos/inc
...
proj: cc lib
	$(CC) $(LDFLAGS) -L $(STM32F0_LIB) -lstm32f0 -L $(FREERTOS_LIB)  -lfreertos_1 -o $(BIN).elf $(OBJ) 
